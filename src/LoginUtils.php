...
class LoginUtils
{
     ...
     *
     * @param  string $text_unformatted texte non formaté
     *
     * @return string
     */
    public static function removeAccents($text_unformatted)
    {
        $accents = [
        ...
        $convert_accents = [
            ...
            'u', 'U', 'u', 'U', 'u', 'U', 'u', 'U', 'u', 'A', 'a', 'AE', 'ae', 'O',
            'o', 'Α', 'α', 'Ε', 'ε', 'Ο', 'ο', 'Ω', 'ω', 'Ι', 'ι', 'ι', 'ι', 'Υ',
            'υ', 'υ', 'υ', 'Η', 'η', ''
        ];

        return str_replace($accents, $convert_accents, $text_unformatted);
    }
     ...
     * @return string
     */
    public static function generate($lastname, $firstname)
    {
        ...
        $login = substr($lastname, 0, 6) . '_' . $firstname[0];
